...
public class PincodeAdapter_Recipient extends RecyclerView.Adapter
{
    List<Pincode> pincodeList;

    public PincodeAdapter_Recipient(List<Pincode> pincodeList)
    {
        ...
        public RowViewHolder(View view)
        {
            ...
            hand_submit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    bundle.putBoolean("Boolean_Value1", false);
